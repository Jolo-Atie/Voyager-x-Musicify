...
export function initSearch(onSelect) {
  ...
  form.addEventListener("submit",async e=>{e.preventDefault();if(results[0]) await choose(results[0]); else find();});
